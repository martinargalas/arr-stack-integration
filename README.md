...
| Transmission | Torrent download client | Optional |
...
### Torrent clients — qBittorrent + Deluge + rTorrent + Transmission *(optional)*
...
| Transmission URL | `http://192.168.1.10:9091` — base URL of Transmission |
